...
struct SignInFormScreen: View {
    ...
    var body: some View {
        ...
        .navigationDestination(isPresented: $showPasswordScreen) {
            SignInPasswordScreen(email: email, isSheetPresented: $isPresented)
...
#Preview {
    ...
    return SignInFormScreen(isPresented: $showSignIn)
}
